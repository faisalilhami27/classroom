...
<div class="error">
  <div class="error-body">
    <h1 class="error-heading">Under Construct</h1>
    <h4 class="error-subheading">Modul ini sedang dalam pengerjaan</h4>
    <p>
      <small>Silahkan hubungi Developer untuk informasi lebih lanjut</small>
    </p>
