...
<div class="error">
  <div class="error-body">
    <h1 class="error-heading">Forbidden</h1>
    <h4 class="error-subheading">Anda dilarang mengakses halaman ini.</h4>
    <p>
      <small>Silahkan hubungi Administrator untuk informasi lebih lanjut</small>
    </p>
