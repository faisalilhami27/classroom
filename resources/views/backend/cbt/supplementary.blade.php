          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive" style="margin-top: 10px">
                <table id="supplementary_table" class="table table-striped table-hover dataTable" width="100%">
                  <thead>
                  <tr>
                    <th width="20px">No</th>
                    <th>Nama Ujian</th>
        ...
        <form action="" id="form_remedial" method="post">
          ...
          <div class="modal-body">
            <div class="form-group" id="data_1">
              <div class="row">
                <div class="col-sm-6 col-md-6">
                  <label class="font-normal" for="start_date">Tanggal Mulai Ujian Susulan <span class="text-danger">*</span></label>
                ...
                <div class="col-sm-6 col-md-6">
                  <label class="font-normal" for="start_time">Waktu Mulai Ujian Susulan <span class="text-danger">*</span></label>
                  <div class="input-group clock_picker" data-autoclose="true">
            ...
            <div class="form-group" id="data_2">
              <div class="row">
                <div class="col-sm-6 col-md-6">
                  <label class="font-normal" for="end_date">Tanggal Selesai Ujian Susulan <span class="text-danger">*</span></label>
                  <div class="input-group date">
                    <span class="input-group-addon bg-primary"><i class="icon icon-calendar"></i></span>
                ...
                <div class="col-sm-6 col-md-6">
                  <label class="font-normal" for="end_time">Waktu Selesai Ujian Susulan <span class="text-danger">*</span></label>
                  <div class="input-group clock_picker" data-autoclose="true">
                    <span class="input-group-addon bg-primary"><i class="icon icon-clock-o"></i></span>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          ...
          <h4 class="modal-title">{{ studentName() }} Ujian Susulan</h4>
        </div>
        <div class="modal-body">
          <div class="table-responsive" style="margin-top: 10px">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          ...
          <h4 class="modal-title">Nilai Ujian Susulan</h4>
        </div>
        <div class="modal-body">
          <div class="table-responsive" style="margin-top: 10px">
...
@push('scripts')
  ...
  <script>
    ...
    table = $('#supplementary_table').DataTable({
      processing: true,
      serverSide: true,
      responsive: true,
      destroy: true,
      ...
      ajax: {
        "url": '{{ route('supplementary.exam.json') }}',
        "type": 'post',
    ...
    const addData = function (id) {
      ...
      $('#id').val(id);
      $('.modal-title').text('Tambah Data Ujian Susulan');
      resetForm();
      getStudent(id);
    }

    // supplementary exam not yes started
    const notYetStarted = function () {
      notification(500, 'Tidak bisa membuat ujian susulan karena ujian pertama belum selesai');
    }
    ...
    $('.btn-submit').click(function (e) {
      ...
      $.ajax({
        ...
        url: '{{ route('supplementary.exam.create') }}',
        type: 'post',
    ...
    const showStudent = function (id) {
      ...
      tableStudent = $('#student_table').DataTable({
        ...
        ajax: {
          "url": '{{ route('supplementary.exam.json.student') }}',
          "type": 'post',
          "headers": {"X-CSRF-TOKEN": "{{ csrf_token() }}"},
          "data": function (d) {
            d.exam_id = id
    ...
    const showScore = function (studentId, examId) {
      ...
      $('#score_table').DataTable({
        ...
        ajax: {
          "url": '{{ route('supplementary.exam.json.student.score') }}',
          "type": 'post',
          "headers": {"X-CSRF-TOKEN": "{{ csrf_token() }}"},
          "data": function (d) {
    ...
    const getStudent = function (id) {
      ...
      $.ajax({
        ...
        url: '{{ route('supplementary.exam.student') }}',
        type: 'get',
        data: {
          exam_id: id
        },
        ...
        success: function (data) {
          if (data.status === 200) {
            let html = '';
            data.data.map(item => {
              html += `<option value="${item.id}">${item.student_identity_number} - ${item.name}</option>`;
            });
