...
@section('content')
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="grade_level_table" class="table table-striped table-hover table-nowrap dataTable" width="100%">
                  <thead>
                  <tr>
                    <th width="20px">No</th>
                    <th>Nama</th>
  ...
  <div id="modal_grade" role="dialog" class="modal fade">
        ...
        <form action="" id="form_grade" method="post">
          ...
          <div class="modal-body">
            <div class="form-group">
              <label for="name">Nama Tingkat Kelas <span class="text-danger">*</span></label>
              <input type="text" name="name" autocomplete="off" id="name" class="form-control" placeholder="Contoh : XII" maxlength="100">
...
@push('scripts')
  <script>
    ...
    table = $('#grade_level_table').DataTable({
      processing: true,
      serverSide: true,
      responsive: true,
      order: [],
    ...
    const addData = function () {
      ...
      $('.modal-title').text('Tambah Data Tingkat Kelas');
      url = '{{ route('grade.level.create') }}';
      type = 'post';
      resetForm();
    }
    ...
    const editData = function (id) {
      $('#modal_grade').modal('show');
      $('.modal-title').text('Edit Data Tingkat Kelas');
      url = '{{ route('grade.level.update') }}';
      type = 'put';
      $.ajax({
        url: '{{ route('grade.level.edit') }}',
        type: 'get',
        data: {id: id},
        dataType: 'json',
